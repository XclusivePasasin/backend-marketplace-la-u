...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Si no hay header Authorization o no empieza con Bearer, sigue adelante sin autenticar
        ...
        // Si el usuario no está ya autenticado en el contexto de seguridad
        if (userUsername != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                ...
                // Registramos al usuario en el sistema para esta petición
